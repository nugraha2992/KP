								...
								<tr>
									<td valign="top" class="bodyContentImageFull" mc:edit="body_content_01">
										<p style="text-align:center;margin:0;padding:0;">
											<img src="http://c0185784a2b233b0db9b-d0e5e4adc266f8aacd2ff78abb166d77.r51.cf2.rackcdn.com/templates/annoucnement-01.jpg"
											 style="display:block;" />
										</p>
									</td>
								</tr>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainerMiddle">
								<tr>
									<td valign="top" class="bodyContent" mc:edit="body_content">
										<h1>Pengumuman </h1>
										<h2><strong>Berikut Hasil Rekapitulasi Performa AOM</strong></h2>
										<p>Silahkan Download Lampiran yang sudah disediakan <br /><br />
											Kami mohon untuk AOM agar senantiasa mengembangakan diri dan terus berusaha meningkatkan kualitas. berikutnya silahkan download hasil rekapitulasi yang ada pada lampiran berikut ini</p>
									</td>
								</tr>
							</table>
							<!-- // END BODY -->
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0" id="templateContainerFooter">
								<tr>
									<td valign="top" width="100%" mc:edit="footer_unsubscribe">
										<h6 style="text-align:center;margin-top: 9px;">PT. Pemodalan Nasional Madani</h6>
									</td>
								</tr>
							</table>
						</td>
